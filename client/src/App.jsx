...
const Ic = {
  ...
  Legislators: (p) => <Svg {...p}><path d="m3 21 18 0"/><path d="M5 21V8l7-5 7 5v13"/><path d="M9 21v-6h6v6"/><path d="M9 10h.01"/><path d="M15 10h.01"/></Svg>,
...
const PAGES = [
  ...
  { key: 'legislators', label: 'Legislators', icon: Ic.Legislators },
